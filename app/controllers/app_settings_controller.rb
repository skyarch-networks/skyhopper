...
class AppSettingsController < ApplicationController
  before_action :authenticate_user!, except: %i[show create system_server_create]

  before_action except: %i[edit_zabbix update_zabbix] do
    if AppSetting.set?
  ...
  def system_server_create
    ...
    Thread.new_with_db do
      ...
      begin
        if create_options[:skip_zabbix_server]
