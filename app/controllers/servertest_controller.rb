...
class ServertestController < ApplicationController
  ...
  def index
    ...
    @serverspecs = Servertest.where(infrastructure_id: @infrastructure_id).page(page)
  ...
  def new
    ...
    @serverspec = Servertest.new(infrastructure_id: infra_id)
  ...
  # POST /serverspecs
  def create
    @serverspec = Servertest.new(global_serverspec_params)
  ...
  def set_servertest
    @serverspec = Servertest.find(params.require(:id))
  end
