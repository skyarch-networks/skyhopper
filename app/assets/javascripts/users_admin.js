    ...
    var App = (function (_super) {
        ...
        App.prototype.get_projects = function () {
            ...
            $.ajax({
                ...
                _this.projects = _.map(projects, function (project) {
                    var client_name = _.find(_this.clients, function (c) { return c.value === _this.selected_client; }).text;
                    return {
                        value: project.id,
        ...
        App.prototype.add = function () {
            ...
            _.forEach(this.selected_projects, function (project_id) {
                var project = _.find(_this.projects, function (p) { return p.value === project_id; });
                _this.allowed_projects.push(project);
                _this.allowed_projects = _.uniq(_this.allowed_projects, function (p) { return p.value; });
            });
        };
        ...
        App.prototype.add_zabbix = function () {
            ...
            _.forEach(this.selected_zabbix, function (zabbix_server_id) {
                var zabbix_server = _.find(_this.zabbix_servers, function (p) { return p.value === zabbix_server_id; });
                _this.allowed_zabbix.push(zabbix_server);
                _this.allowed_zabbix = _.uniq(_this.allowed_zabbix, function (p) { return p.value; });
            });
        };
        ...
        App.prototype.update_mfa = function () { this.update_mfa_key = true; };
        App.prototype.remove_mfa = function () { this.remove_mfa_key = true; };
        App.prototype.submit = function () {
            var _this = this;
            var body = {};
            body.allowed_projects = _.map(this.allowed_projects, function (p) { return p.value; });
            body.allowed_zabbix = _.map(this.allowed_zabbix, function (p) { return p.value; });
